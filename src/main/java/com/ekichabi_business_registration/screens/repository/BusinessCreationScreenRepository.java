...
public class BusinessCreationScreenRepository {
    ...
    private class CategorySelectionScreen extends Screen {
        ...
        CategorySelectionScreen(
                String name, String phone, String district, String village, int page) {
            super(true);
            this.name = name;
            this.phone = phone;
            this.district = district;
            ...
            if (c == '*') {
                ...
                switch (sb.charAt(0)) {
                    case '1':
                        ...
                        return new CreateBusinessConfirmationScreen(
                                name, phone, district, village, categoryEntity);
                    case '2':
                        categoryEntity = CategoryEntity.builder()
                                .name("Financial Services").build();
                        return new CreateBusinessConfirmationScreen(
                                name, phone, district, village, categoryEntity);
                    case '3':
                    ...
                    case '7':
                        categoryEntity = CategoryEntity.builder()
                                .name("Trading and Wholesale").build();
                        return new CreateBusinessConfirmationScreen(
                                name, phone, district, village, categoryEntity);
                    case '8':
                        categoryEntity = CategoryEntity.builder().name("Transport").build();
                    case '9':
                        return new CategorySelectionScreen(name, phone, district, village, 0);
                    case '0':
                        return new CategorySelectionScreen(name, phone, district, village, 1);
                    default:
                        return this;
                }
            } else {
    ...
    private class CreateBusinessConfirmationScreen extends Screen {
        ...
        CreateBusinessConfirmationScreen(
                String name, String phone, String district, String village,
